...
\footercontent{
  ...
  PyTorch Conference Europe 2025, Paris \hfill
  ...
  \begin{columns}[t]
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{NNCF Compression API}
        ...
        \begin{figure}
          \centering
          \includesvg[width=0.85\colwidth]{figures/quantization_flow}
      ...
      \begin{block}{Weight Compression --- \texttt{compress\_pt2e}}
        ...
        \begin{itemize}
          \item \textbf{Scale Estimation}  --- Estimates optimal quantization scales for 4-bit layers to further reduce perplexity of compressed LLMs.
                ...
                \begin{figure}
                  \centering
                  \includesvg[width=0.85\colwidth]{figures/scale_estimation}
                  \caption{Visual scheme of Scale Estimation algorithm.}
                \end{figure}
